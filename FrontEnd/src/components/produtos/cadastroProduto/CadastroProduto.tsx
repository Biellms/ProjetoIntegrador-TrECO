import { Box, Button, Card, CardContent, Container, FormControl, FormHelperText, Grid, InputLabel, MenuItem, Select, styled, TextField, Typography } from '@material-ui/core'
...
function CadastroProduto() {
    ...
    return (
        <Box className='containerproduto'>
        <Container maxWidth="sm" className='containerproduto2'>
            <Box className='box-atualizar-produto'>
